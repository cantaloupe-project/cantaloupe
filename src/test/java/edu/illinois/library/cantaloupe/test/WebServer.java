...
/**
 * <p>Simple HTTP server wrapping a Jetty server for convenient functional testing.
 * Supports HTTP and HTTPS and protocol versions 1.1 and 2.</p>
 *
...
public final class WebServer {
    ...
    private String authRealm = BASIC_REALM;
    private String authUser = BASIC_USER;
    private String authSecret = BASIC_SECRET;
    ...
    private boolean isHTTPS1Enabled = true;
    private boolean isHTTPS2Enabled = true;
    ...
    public WebServer() {
        ...
        setRoot(imagesPath);
        setKeyStorePath(TestUtil.getFixture("keystore-password.jks"));
    }
