package edu.illinois.library.cantaloupe.perf.processor.codec.gif;

import java.util.concurrent.TimeUnit;

import edu.illinois.library.cantaloupe.processor.codec.gif.GIFImageWriterTest;
...
public class GIFImageWriterPerformance extends GIFImageWriterTest {
    ...
    public void testWriteWithBufferedImageWritesXMPMetadata() throws Exception {
        super.testWriteWithBufferedImageWritesXMPMetadata();
    }
    ...
    public void testWriteWithPlanarImageWritesXMPMetadata() throws Exception {
        super.testWriteWithPlanarImageWritesXMPMetadata();
    }
