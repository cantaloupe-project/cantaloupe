...
public class HTTPStreamFactory2Test extends BaseTest {
    ...
    private HTTPStreamFactory2 newInstance() {
        return newInstance(true);
    }

    private HTTPStreamFactory2 newInstance(boolean serverAcceptsRanges) {
    ...
    public void testIsSeekingDirect() {
        final HTTPStreamFactory2 instance = newInstance();
