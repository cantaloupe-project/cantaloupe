...
abstract class HttpSourceTest extends AbstractSourceTest {
    ...
    private static class RequestCountingHandler extends DefaultHandler {
        ...
        @Override
        public boolean handle(Request request, org.eclipse.jetty.server.Response response, Callback callback) throws IllegalArgumentException {
    ...
    void testGetFormatIteratorNext() throws Exception {
        ...
        server.setHandler(new DefaultHandler() {
            ...
            public boolean handle(Request request, org.eclipse.jetty.server.Response response, Callback callback) throws IOException {
                ...
                responseHeaders.put(HttpHeader.ACCEPT_RANGES, "bytes");
                try (OutputStream os = Sink.asOutputStream(response)) {
