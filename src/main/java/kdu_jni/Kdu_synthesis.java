...
public class Kdu_synthesis extends Kdu_pull_ifc {
  ...
  private static native long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, int _pull_offset, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags);
  public Kdu_synthesis(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, int _pull_offset, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags) {
    this(Native_create(_node, _allocator, _use_shorts, _normalization, _pull_offset, _env, _env_queue, _flags));
  }
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts)
  {
    ...
    return Native_create(_node,_allocator,_use_shorts,(float) 1.0F,(int) 0,env,env_queue,(int) 0);
  }
  ...
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization)
  {
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_node,_allocator,_use_shorts,_normalization,(int) 0,env,env_queue,(int) 0);
  }
  ...
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, int _pull_offset)
  {
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_node,_allocator,_use_shorts,_normalization,_pull_offset,env,env_queue,(int) 0);
  }
  ...
  {
    Kdu_thread_queue env_queue = null;
    return Native_create(_node,_allocator,_use_shorts,_normalization,_pull_offset,_env,env_queue,(int) 0);
  }
  ...
  private static long Native_create(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, int _pull_offset, Kdu_thread_env _env, Kdu_thread_queue _env_queue)
  {
    return Native_create(_node,_allocator,_use_shorts,_normalization,_pull_offset,_env,_env_queue,(int) 0);
  }
  public Kdu_synthesis(Kdu_node _node, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, int _pull_offset, Kdu_thread_env _env, Kdu_thread_queue _env_queue) {
    this(Native_create(_node, _allocator, _use_shorts, _normalization, _pull_offset, _env, _env_queue));
  }
  private static native long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_thread_env _env, Kdu_thread_queue _env_queue);
  public Kdu_synthesis(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization, Kdu_thread_env _env, Kdu_thread_queue _env_queue) {
  ...
  private static long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts)
  {
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_resolution,_allocator,_use_shorts,(float) 1.0F,env,env_queue);
  }
  ...
  private static long Native_create(Kdu_resolution _resolution, Kdu_sample_allocator _allocator, boolean _use_shorts, float _normalization)
  {
    Kdu_thread_env env = null;
    Kdu_thread_queue env_queue = null;
    return Native_create(_resolution,_allocator,_use_shorts,_normalization,env,env_queue);
  }
  ...
  {
    Kdu_thread_queue env_queue = null;
    return Native_create(_resolution,_allocator,_use_shorts,_normalization,_env,env_queue);
  }
