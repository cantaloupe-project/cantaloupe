...
public class Kdu_platform_file_source extends Kdu_compressed_source implements AutoCloseable {
  static {
    System.loadLibrary("kdu_jni");
    Native_init_class();
  }
  private static native void Native_init_class();
  protected Kdu_platform_file_source(long ptr) {
    super(ptr);
  }
  ...
  public Kdu_platform_file_source() {
    this(Native_create());
  }
  private static native long Native_create(String _fname, boolean _allow_seeks);
  public Kdu_platform_file_source(String _fname, boolean _allow_seeks) {
  ...
  public Kdu_platform_file_source(String _fname) {
