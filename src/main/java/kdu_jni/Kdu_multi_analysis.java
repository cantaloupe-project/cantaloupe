...
public class Kdu_multi_analysis {
  ...
  public native long Create(Kdu_codestream _codestream, Kdu_tile _tile, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags, Kdu_roi_image _roi, int _buffer_rows, Kdu_sample_allocator _external_sample_allocator) throws KduException;
  public long Create(Kdu_codestream _codestream, Kdu_tile _tile, Kdu_thread_env _env, Kdu_thread_queue _env_queue, int _flags) throws KduException
  {
    ...
    return Create(_codestream,_tile,_env,_env_queue,_flags,roi,(int) 1,external_sample_allocator);
  }
  ...
  {
    Kdu_sample_allocator external_sample_allocator = null;
    return Create(_codestream,_tile,_env,_env_queue,_flags,_roi,(int) 1,external_sample_allocator);
  }
  ...
  {
    Kdu_sample_allocator external_sample_allocator = null;
    return Create(_codestream,_tile,_env,_env_queue,_flags,_roi,_buffer_rows,external_sample_allocator);
  }
