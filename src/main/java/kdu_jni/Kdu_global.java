...
public class Kdu_global {
  ...
  public static final int KDU_BLOCK_CODER_CAP_J2K1 = (int) 0x001;
  ...
  public static final int KDU_DCO = (int) 0xFF70;
  public static final int KDU_QPD = (int) 0xFF5A;
  public static final int KDU_QPC = (int) 0xFF5B;
  public static final int KDU_VMS = (int) 0xFF71;
  public static final int KDU_RLT = (int) 0xFF95;
  public static final int KDU_SEC = (int) 0xFF65;
  public static final int KDU_INSEC = (int) 0xFF94;
  public static final int KDU_NSI = (int) 0xFF54;
  public static final int KDU_EPB = (int) 0xFF66;
  public static final int KDU_ESD = (int) 0xFF67;
  public static final int KDU_EPC = (int) 0xFF68;
  public static final int KDU_RED = (int) 0xFF69;
  public static final int KDU_HDT = (int) 0xFF7A;
  ...
  public static final int KDU_SOURCE_CAP_MEMORY_BACKED = (int) 0x0010;
  public static final int KDU_SOURCE_CAP_ASYNC_NOTIFICATION = (int) 0x0020;
  public static final int KDU_SOURCE_SPAN_EXISTS = (int) 0x0001;
  public static final int KDU_SOURCE_IS_COMPLETE = (int) 0x0002;
  public static final int KDU_SOURCE_WILL_NOTIFY = (int) 0x0004;
  public static final int KDU_MEMBACKED_SOURCE_UNSERVICED = (int) 1;
  public static final int KDU_MEMBACKED_SOURCE_PARTIALLY_SERVICED = (int) 2;
  public static final int KDU_MEMBACKED_SOURCE_FULLY_SERVICED = (int) 3;
  ...
  public static final int KDU_CS_RESTRICT_REGION = (int) 8;
  public static final int KDU_CS_RESTRICT_QUALITY = (int) 16;
  ...
  public static final int KDU_LOAD_SEQUENTIAL_WANT_TILE = (int) 1;
  public static final int KDU_LOAD_SEQUENTIAL_WANT_FLUSH_SET = (int) 2;
  public static final int KDU_LOAD_SEQUENTIAL_WANT_PACKET_BYTES = (int) 4;
  ...
  public static final String ENC_params = (String) "ENC";
  ...
  public static final String Content_type = (String) "Content_type";
  ...
  public static final String Cprog_weights = (String) "Cprog_weights";
  public static final String Ctype = (String) "Ctype";
  public static final String Cxfgain = (String) "Cxfgain";
  ...
  public static final String Qfband_weights = (String) "Qfband_weights";
  public static final String Qfactor = (String) "Qfactor";
  public static final String Qfparams = (String) "Qfparams";
  ...
  public static final int Content_type_PHOTO = (int) 1;
  public static final int Content_type_SCREEN = (int) 2;
  public static final int Content_type_GRAPHICS = (int) 4;
  public static final int Content_type_ENCODED = (int) 8;
  public static final int Ctype_N = (int) 0;
  public static final int Ctype_Y = (int) 1;
  ...
  public static final int KDU_FOREIGN_SIGNAL_EXPECTED = (int) 1;
  public static final int KDU_FOREIGN_SIGNAL_EXCEPTION = (int) 2;
  ...
  public static final int KDU_TIFF_ExtraSamples_UNASSOCIATED_ALPHA = (int) 2;
  ...
  public static final long jpx_ht_baseline_brand = (long) 0x6a687862;
  ...
  public static final int JPX_SF_HTJ2K = (int) 86;
