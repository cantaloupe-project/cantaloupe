...
public enum Key {
    ...
    HTTP_HOST("http.host"),
    HTTP_PORT("http.port"),
    HTTPRESOLVER_BASIC_AUTH_SECRET("HttpResolver.BasicLookupStrategy.auth.basic.secret"),
    HTTPRESOLVER_BASIC_AUTH_USERNAME("HttpResolver.BasicLookupStrategy.auth.basic.username"),
