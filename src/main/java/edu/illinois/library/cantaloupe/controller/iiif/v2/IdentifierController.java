...
/**
 * Spring Boot controller for IIIF Image API 2.x identifier redirects.
 * Redirects /{identifier} to /{identifier}/info.json.
 * Replaces the previous iiif.v2.IdentifierResource class.
 */
@RestController("v2IdentifierController")
...
public class IdentifierController extends AbstractIIIFController {
    ...
    public ResponseEntity<Void> redirectToInfo(@PathVariable String identifier,
        ...
        String redirectUrl = request.getContextPath() + "/iiif/2/" + identifier + "/info.json";
