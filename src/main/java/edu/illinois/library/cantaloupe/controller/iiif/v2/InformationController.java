...
import edu.illinois.library.cantaloupe.resource.iiif.v2.Information;
import edu.illinois.library.cantaloupe.resource.iiif.v2.InformationFactory;
import edu.illinois.library.cantaloupe.source.StatResult;
import jakarta.servlet.http.HttpServletRequest;
import jakarta.servlet.http.HttpServletResponse;

/**
 * Spring Boot controller for IIIF Image API 2.x information requests.
 ...
 *
 * @see <a href="https://iiif.io/api/image/2.0/#image-information-request-uri-syntax">
 *     Image Information Requests</a>
 */
@RestController("v2InformationController")
...
public class InformationController extends AbstractIIIFController {
    ...
    private Information<String, Object> createErrorInformation(ResourceException exception,
        ...
        try {
            map.putAll(iiifrequest.getDelegateProxy().getExtraIIIF2InformationResponseKeys());
        } catch (Exception e) {
