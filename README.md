...
Cantaloupe is tested to work on the two most recent LTS versions of Java (currently 21 and 25) and latest non-LTS (currently 27).
...
* RustFS (for S3SourceTest & S3CacheTest)
